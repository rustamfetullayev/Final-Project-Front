...
$('#news .inner .text p .read').click(function(){
    $(this).css('display','none');
    $(this).next('.more').css('display','inline-block');
    $(this).parent().children('.less').css('display','inline-block');
})

$('#news .inner .text p .less').click(function(){
    $(this).css('display','none');
    $(this).parent().children('.more').css('display','none');
    $(this).parent().children('.read').css('display','inline-block');
})


$('#news .inner .mini_img img').click(function(){
...
$('#edit_usr_profile .setting_nav ul #edit').click(function(){
    if(!$(this).hasClass('active')){
        ...
        $('#edit_usr_profile .screen .edit_profile').siblings().removeClass('selected');
    }
})
...
$('#edit_usr_profile .setting_nav ul #pass').click(function(){
    if(!$(this).hasClass('active')){
        ...
        $('#edit_usr_profile .screen .edit_pass').siblings().removeClass('selected');
    }
})
...
$('#edit_usr_profile .setting_nav ul #pic').click(function(){
    if(!$(this).hasClass('active')){
        ...
        $('#edit_usr_profile .screen .edit_pic').siblings().removeClass('selected');
    }
})
